...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the camera's LED switch status, without the LED model, this function returns an error code that does not supserial.
/// \param [in] hCamera Camera handle.
/// \param [in] index The index of the LED, starting from 0. If there is only one LED that can control the brightness, this parameter is 0.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the camera's LED brightness, without the LED model, this function returns an error code that does not supserial.
/// \param [in] hCamera Camera handle.
/// \param [in] index The index of the LED, starting from 0. If there is only one LED that can control the brightness, this parameter is 0.
